...
#ifndef EXTRACTOR_SOFTMAX_LABEL_H
#define EXTRACTOR_SOFTMAX_LABEL_H
#include "labelcontext.h"
class SoftMaxLabel :public LabelContext{
public:
    /**
     * 多分类构造函数
     ...
     */
    SoftMaxLabel(int hash_size,int label_hash_size):hash_size(hash_size),label_hash_size(label_hash_size){}
    ~SoftMaxLabel(){}
...
#endif //EXTRACTOR_SOFTMAX_LABEL_H
